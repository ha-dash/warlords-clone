...
export class RenderEngine {
        ...
        for (let y = visibleArea.minY; y <= visibleArea.maxY; y++) {
            for (let x = visibleArea.minX; x <= visibleArea.maxX; x++) {
                ...
                if (hex) {
                    ...
                    this.renderHex(hex, hexSize, spacing);
    ...
    renderHex(hex, hexSize, spacing) {
        ...
        this.renderTerrainDetails(hex, x, y, hexSize);
    }
     ...
     */
    renderTerrainDetails(hex, x, y, size) {
        ...
        switch (hex.terrain) {
            ...
            case 'ROAD':
                ...
                this.ctx.stroke();
                break;
            // PLAINS gets no special indicator
        }
    }
    ...
    renderCity(city, hexSize, spacing) {
        ...
        if (sprite) {
            ...
            // Draw city symbol
            this.ctx.fillStyle = '#000000';
            this.ctx.font = `${Math.floor(hexSize / 3)}px Arial`;
            this.ctx.textAlign = 'center';
            this.ctx.textBaseline = 'middle';
